...
class Settings:
    ...
    SCANNER_EVAL_DIR: str = "data_5x5iA"
    SCANNER_EVAL_ROLL_DAILY: bool = True
    ...
    PT_LOOP_SLEEP_SEC: float = float(PAPER_LOOP_SECONDS)
